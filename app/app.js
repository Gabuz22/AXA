...
const HELP = {
  ...
  besoins: { what: "Le cas client : coche ce que tu sais, le diagnostic (risques priorisés, trous, doublons, présélection classée de contrats) se construit au fur et à mesure.", how: ["Renseigne profil, événements, besoins et contrats en place — dans n'importe quel ordre.", "Chaque élément porte son statut : déclaré, déduit ou hypothèse.", "L'âge et le budget affinent la présélection : les limites d'adhésion sont lues dans les notices et citées.", "Ouvre « les contrats écartés » — aucun contrat n'est retiré sans motif.", "Poursuis vers la fiche contrat ou la préparation de RDV."] },
